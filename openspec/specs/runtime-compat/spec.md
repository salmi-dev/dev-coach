...
Define how the package supports multiple JavaScript runtimes (Deno, Bun, Node) through a single explicit adapter, and how that compatibility is declared on JSR
and proved by CI.
