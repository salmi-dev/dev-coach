...
`coach install-pi` SHALL detect the skill directory by checking for `.pi/skills/`, `.codex/skills/`, `.github/skills/` in the current directory (in that order).
If none exist, it SHALL create `.pi/skills/`. It SHALL copy all 7 SKILL.md files and tool definitions into the detected directory.
