...
The system SHALL provide a `regenerateDashboard()` function that queries the DB and writes an updated `{library}/README.md` with: ASCII art header, stats
summary (total sessions, snippet/tldr/project counts), recent snippets (last 5), TLDRs list, and projects list.
