...
import { toSlug, saveItem, readItem, deleteItem, listItems } from "../src/storage/library.ts";
...
Deno.test("search by lang filters correctly", () => {
  ...
  db.prepare("INSERT INTO items (type, title, path, lang, tags, created) VALUES (?, ?, ?, ?, ?, ?)").run("snippet", "P1", "p1.md", "python", "[]", "2026-04-30");
